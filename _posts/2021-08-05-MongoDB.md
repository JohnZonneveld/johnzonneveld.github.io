...
The installation itself is pretty simple, all that is needed when brew is installed is 'brew install mongodb-community@5.0' to install the latest version.
